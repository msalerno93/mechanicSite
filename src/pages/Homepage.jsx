...
const Homepage = () => {
  return (
    <section className="w-full flex xl:flex-row flex-col justify-center min-h-screen p-10 gap-10 max-container">
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <p className="font-serif font-family:Georgia text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">
